...
bool GraphicsSystem::init(int argc, char *argv[])
{
	...
	cam = new Camera(0.0f, 700.0f, 1300.0f);
	//cam = new Camera(0.0f, 0.0f, 0.0f);

	cam->setCamSpecs(45.0f, (float)(winSize.x / winSize.y), 0.01f, powf(10, 8));
...
Vector2 GraphicsSystem::handleMouseMovement()
{
	double mouseX;
	double mouseY;
